...
//				.permitAll().and().logout().permitAll();
		http.csrf().disable().authorizeRequests()
				...
				.hasAnyAuthority("AUTHORITY_USER", "AUTHORITY_ROLE").antMatchers("/employee/view_permits")
				.hasAuthority("VIEW_PERMITS").antMatchers("/employee/view_confirmed_permits")
				.hasAuthority("VIEW_CONFIRMED_PERMITS").antMatchers("/employee/view_requested_permits")
